...
net = cv2.dnn.readNet("models/object_detection_model/weights/yolov3-tiny.weights", "models/object_detection_model/config/yolov3-tiny.cfg")

#classes that we have to detect using Object Detection Model
label_classes = []

with open("models/object_detection_model/objectLabels/coco.names","r") as file:
